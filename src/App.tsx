...
const CHEF_PHOTOS = [
  ...
  { src: '/images/chef_fish_2.jpg', label: 'Sourcing Giant Grouper' },
  { src: '/images/chef_kitchen_team.jpg', label: 'Chef Muami with Kitchen Staff' },
  { src: '/images/chef_pool_pose.jpg', label: 'Culinary Director - Chef Muami' },
